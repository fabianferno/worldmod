  ...
  return (
    <main className="mx-auto flex min-h-dvh w-full max-w-md flex-col justify-center px-6 py-12">
      ...
      <div className="mt-8 space-y-3">
        <Link
          href="/c"
          className="block rounded-xl bg-white px-4 py-3.5 text-center font-semibold text-neutral-950"
        >
        ...
        <Link
          href="/b/bounties"
          className="block rounded-xl border border-white/20 px-4 py-3.5 text-center font-semibold"
        >
      ...
      <p className="mt-8 text-xs leading-relaxed text-white/35">
        ...
        <span className="text-white/55">heuristic</span> trust level: the checks measure
